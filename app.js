...
document.addEventListener("DOMContentLoaded", () => {
  ...
  const THEMES = {
    ...
    purple: { type: "light", "--bg": "#e2c9fc", "--card": "#ead6ff", "--accent": "#211634", "--accent-2": "#7c3aed", "--muted": "#6b5b7a" },
    green: { type: "light", "--bg": "#beffd1", "--card": "#dcfce7", "--accent": "#04260f", "--accent-2": "#10b981", "--muted": "#4b6b53" },
    red: { type: "light", "--bg": "#ff8383", "--card": "#fcbbbb", "--accent": "#2a0a0a", "--accent-2": "#ef4444", "--muted": "#a64b4b" },
    orange: { type: "light", "--bg": "#ffcdb0", "--card": "#ffd8bf", "--accent": "#2b1a00", "--accent-2": "#f97316", "--muted": "#b36b3b" },
    teal: { type: "light", "--bg": "#a5f7e4", "--card": "#bcfaec", "--accent": "#042f2e", "--accent-2": "#14b8a6", "--muted": "#4a7c79" },
    yellow: { type: "light", "--bg": "#fdeeb3", "--card": "#fcefc3", "--accent": "#2b2a00", "--accent-2": "#facc15", "--muted": "#a68c4b" },
    cyan: { type: "light", "--bg": "#76d6db", "--card": "#a5e3e9", "--accent": "#042f2e", "--accent-2": "#06a3be", "--muted": "#4b7c82" },
    brown: { type: "light", "--bg": "#a5704d", "--card": "#ddb191", "--accent": "#2a1c14", "--accent-2": "#92400e", "--muted": "#7a5c4a" },
    slate: { type: "light", "--bg": "#919daa", "--card": "#b2bcc9", "--accent": "#0f172a", "--accent-2": "#64748b", "--muted": "#64748b" },
    olive: { type: "light", "--bg": "#edffa4", "--card": "#effabd", "--accent": "#2a2f1b", "--accent-2": "#84a21d", "--muted": "#6b7450" },
    rose: { type: "light", "--bg": "#fc9da3", "--card": "#fabcc0", "--accent": "#2a0a12", "--accent-2": "#f43f5e", "--muted": "#a8576c" },
    ice: { type: "light", "--bg": "#a7dbfd", "--card": "#c3e7ff", "--accent": "#082f49", "--accent-2": "#28bfff", "--muted": "#5b7c92" },
    indigo: { type: "light", "--bg": "#a7baf8", "--card": "#cbd7ff", "--accent": "#1e1b4b", "--accent-2": "#6366f1", "--muted": "#6b6fa1" },
  };
