...
/* -------- THEMES -------- */
const THEMES = { dark: { '--bg':'#0f172a','--card':'#1e293b','--accent':'#f1f5f9','--accent-2':'#3b82f6','--muted':'#94a3b8' }, 
...
function updateGenres() { 
  ...
  categories[typeSelect.value].forEach(c=>{ const o=document.createElement('option'); 
